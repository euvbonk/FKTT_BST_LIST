    ...
    <table border="0">
        <tr>
            ...
            <td colspan="2"><select name="daysOfWeek" size="1"><?php $this->printFunc('getDaysOfWeekOptionsUI'); ?></select></td>
        ...
        <tr>
            ...
            <td colspan="2"><input type="text" name="lengthPerCar" size="4" maxlength="4" value="<?php $this->printFunc('getLengthPerCar'); ?>"/></td>
            <td style="text-align: right;"><input type="submit" value="Filter l&ouml;schen" name="reset" /></td>
        </tr>
        <tr>
            <td style="text-align:right;">Epoche:&nbsp;</td>
            <td colspan="2"><select name="epoch" size="1" style="width:45px;"><?php $this->printFunc('getEpochOptionsUI'); ?></select></td>
            <td rowspan="1"><input type="hidden" name="cmd" value="calculate" /></td>
        </tr>
        <tr>
            <td style="text-align:right;">Filter f&uuml;r Betriebsstellen:&nbsp;</td>
            <td colspan="3"><input type="text" name="filterCSV" size="45" maxlength="50" value="<?php $this->printFunc('getFilterCSV'); ?>"/></td>
        </tr>
    </table>
    <?php $this->printFunc('getTable'); ?>
    <p>Minimale Zuganzahl zum Abfahren aller Frachten in diesem Abschnitt: <?php $this->printFunc('getMinTrainCount'); ?></p>
    </form>
    <p class="klein" style="position: relative; bottom: 1.5%; border-top: 1px solid gray; width: 97%; padding-top: 10px;">
       zuletzt ge&auml;ndert: <?php $this->getLastChangeTimestamp(); ?>
       <br/>
