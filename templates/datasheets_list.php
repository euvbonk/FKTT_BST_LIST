      ...
      <form action="<?php $this->printValue('getFormActionUri'); ?>" method="post">
          <table border="0"><tr><td style="text-align: right;">Ordnen nach:&nbsp;</td><td><select name="order" size="1"><?php $this->printValue('getOrderOptionsUI'); ?></select></td></tr><tr><td style="text-align: right;">Epoche:&nbsp;</td><td><select name="epoch" size="1" style="width:45px;"><?php $this->printValue('getEpochOptionsUI'); ?></select></td></tr><tr><td style="text-align: right;"><input type="submit" name="startFilter" value="Start" /></td><td style="text-align: right;"><input type="submit" value="Filter l&ouml;schen" name="reset" /></td></tr></table>
          <!-- BSTLIST_ENTRY_FOR_FKTT_PORTAL --><?php $this->printValue('getTable'); ?><!-- BSTLIST_FLUSH_FOR_FKTT_PORTAL -->
      </form>
      <p><?php $this->printValue('getYellowPageLink'); ?></p>
      ...
      <p>Neues Datenblatt anlegen: <?php $this->printValue('getApplicationUrl'); ?> Editor</p>
      ...
      <p><?php $this->printValue('getCSVListLink'); ?></p>
      <p><?php $this->printValue('getZipBundleLink'); ?></p>
      <hr />
      <p class="klein">
