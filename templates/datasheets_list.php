      ...
      <form action="<?php $this->printFunc('getFormActionUri'); ?>" method="post">
          <table border="0"><tr><td style="text-align: right;">Ordnen nach:&nbsp;</td><td><select name="order" size="1"><?php $this->printFunc('getOrderOptionsUI'); ?></select></td></tr><tr><td style="text-align: right;">Epoche:&nbsp;</td><td><select name="epoch" size="1" style="width:45px;"><?php $this->printFunc('getEpochOptionsUI'); ?></select></td></tr><tr><td style="text-align: right;"><input type="submit" name="startFilter" value="Start" /></td><td style="text-align: right;"><input type="submit" value="Filter l&ouml;schen" name="reset" /></td></tr></table>
          <!-- BSTLIST_ENTRY_FOR_FKTT_PORTAL --><?php $this->printFunc('getTable'); ?><!-- BSTLIST_FLUSH_FOR_FKTT_PORTAL -->
      </form>
      <p><?php $this->printFunc('getYellowPageLink'); ?></p>
      ...
      <p>Neues Datenblatt anlegen: <?php $this->printFunc('getApplicationUrl'); ?> Editor</p>
      ...
      <p><?php $this->printFunc('getCSVListLink'); ?></p>
      <p><?php $this->printFunc('getZipBundleLink'); ?></p>
      <hr />
      <p class="klein">
