      ...
      <form action="<?php $this->printValue('FormActionUri'); ?>" method="post" style="padding-bottom: 1%;">
          <table style="margin-bottom: 1%;"><tr><td style="text-align: right;">Ordnen nach:&nbsp;</td><td><label><select name="order" size="1"><?php $this->printValue('OrderOptionsUI'); ?></select></label></td></tr><tr><td style="text-align: right;">Epoche:&nbsp;</td><td><label><select name="epoch" size="1" style="width:45px;"><?php $this->printValue('EpochOptionsUI'); ?></select></label></td></tr><tr><td style="text-align: right;">Land:&nbsp;</td><td><label><select name="country" size="1"><?php $this->printValue('CountryOptionsUI'); ?></select></label></td></tr><tr><td style="text-align: right;"><input type="submit" name="startFilter" value="Start"></td><td style="text-align: right;"><input type="submit" value="Filter l&ouml;schen" name="reset"></td></tr></table>
